...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center border-b px-8 py-2 shadow sticky top-0 z-40 bg-white">
      ...
      {/* Mobile */}
      <div className={`fixed inset-0 ${toggleSidebar ? "flex sm:hidden" : "hidden"} justify-start bg-neutral-900/40 z-50 overflow-hidden transition-all duration-300 ease-in-out`}>
        <div className={`relative w-full h-full flex flex-col justify-between pt-4 max-w-[250px] bg-[#de7665] rounded-e-lg transition-transform ease-in-out duration-200 transform ${toggleContent ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="px-4">
            ...
            <ul className="my-12 space-y-2">
              ...
              <li>
                <Link href="/dashboard/local-infos" className={`relative flex items-center gap-2 p-2 rounded text-sm ${selected === "LocalInfos" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => handleItemClick("Home")}>
              ...
              <li>
                <Link href="/dashboard/videos" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Videos" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`}>
              ...
              <li>
                <Link href="/dashboard/services-index" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Services" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`}>
            ...
            <p className={`text-sm font-medium text-black/50 px-2 mb-4`}>Paramètres</p>
            <ul className="mt-2 space-y-2">
              <li>
                <Link href="/dashboard/members" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Utilisateurs" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`}>
              ...
              <li>
                <Link href="/dashboard/report" className="flex items-center gap-2 font-medium p-2 text-sm rounded hover:bg-orange-50">
              ...
              <li>
                <Link href="/dashboard/preferences" className="flex items-center gap-2 font-medium p-2 text-sm rounded hover:bg-orange-50">
