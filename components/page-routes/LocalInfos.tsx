...
const LocalInfos = () => {
  const [localInfo, setLocalInfo] = useState(0)
    ...
    <div className="w-full">
      ...
      <div className="w-full flex flex-col gap-4 mt-4">
        ...
        <div className="w-full h-[11rem] flex justify-between border border-gray-300 p-2 rounded-xl">
          ...
          <div className="flex flex-col justify-between items-end">
            <div className="flex items-center gap-4">
              ...
              {/* Actions */}
              <button className="relative flex items-center font-semibold w-6 h-6 rounded border-2 border-gray-300" onClick={() => setLocalInfo(localInfo === 1 ? 0 : 1)}>
                ...
                <div className={`absolute -bottom-2 translate-y-full right-0 w-[150px] max-w-[150px] ${localInfo === 1 ? "block" : "hidden"} rounded shadow bg-white p-2 z-10`}>
                  <ul className="flex flex-col gap-1">
                    <li className="flex items-center gap-2 px-2 py-1 hover:bg-gray-100 rounded text-[13px]">
                      Modifier
                    </li>
                    <li className="flex items-center gap-2 px-2 py-1 rounded text-white bg-red-500 text-[13px]">
                      Supprimer
                    </li>
                  </ul>
                </div>
        ...
        <div className="w-full h-[11rem] flex justify-between border border-gray-300 p-2 rounded-xl">
          ...
          <div className="flex flex-col justify-between items-end">
            <div className="flex items-center gap-4">
              ...
              {/* Published status */}
              <button type="button" className="px-3 py-1 text-xs font-medium text-center text-white bg-index-700 rounded-lg hover:bg-index-800 focus:ring-4 focus:outline-none focus:ring-index-300">Publier</button>
              {/* Actions */}
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="w-full h-[11rem] flex justify-between border border-gray-300 p-2 rounded-xl">
            {/* Left side */}
            <div className="flex gap-4">
              {/* Image */}
              <div className="w-[8rem] h-full bg-gray-200 rounded-xl animate-pulse"></div>
      ...
      <nav aria-label="Page navigation example" className="flex justify-center mt-8">
        <ul className="inline-flex -space-x-px text-base h-10">
          ...
          <li>
            <a href="#" className="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 text-sm bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">3</a>
          </li>
          <li>
