    ...
    <div className="flex-1">
        ...
        <div className="flex gap-1">
          ...
          <div className="inline-flex rounded-md shadow-sm relative" role="group">
            ...
            <div className={`absolute right-0 w-48 p-2 -bottom-2 translate-y-full origin-bottom-right z-10 ${toggleAddDropdown ? "" : "hidden"} bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}>
              ...
              <button className="w-full flex items-center gap-2 p-2 rounded bg-gray-900 text-white hover:bg-gray-800" onClick={() => setToggleModalVideo(true)}>
      ...
      <div className="flex justify-between items-center my-6">
        <div className="flex gap-2">
          ...
          <button id="dropdownSort" data-dropdown-toggle="dropdown" className="relative px-3 py-2 text-xs font-medium text-center text-gray-700 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 inline-flex items-center" type="button" onClick={() => setToggleSortDropdown(!toggleSortDropdown)}>
            Trier par
            <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
            </svg>
