  ...
  return (
    <div className="fixed bottom-8 right-4 w-14 h-14 z-50">
        <div className="w-full h-full relative flex items-center justify-center">
            <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-3 text-center md:hidden inline-flex items-center justify-center" onClick={handleClick}>
            ...
            {/* Absolutes buttons */}
            <div id='add-video' className="absolute -z-10">
