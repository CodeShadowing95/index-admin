      ...
      <div className="h-full pt-4 flex flex-col justify-between">
        ...
        <div className="px-4">
          ...
          <ul className="mt-12 space-y-2">
            ...
            <li>
              <a href="#" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Users" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => setSelected("Users")}>
