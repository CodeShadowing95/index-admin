      ...
      <div className="h-full pt-4 flex flex-col justify-between relative">
        ...
        <div className="px-4">
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li>
              <Link href="/dashboard/preferences" className="flex items-center gap-2 font-medium p-2 text-sm rounded hover:bg-orange-50" onClick={() => handleItemClick("Signaler")} onMouseEnter={() => setTooltip("Signaler")} onMouseLeave={() => setTooltip("")}>
