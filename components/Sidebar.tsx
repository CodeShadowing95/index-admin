      ...
      <div className="h-full pt-4 flex flex-col justify-between relative">
        ...
        <div className="px-4">
          ...
          <ul className="mt-12 space-y-2">
            <li>
              <Link href="/dashboard" className={`relative flex items-center gap-2 p-2 rounded text-sm ${selected === "Home" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => setSelected("Home")} onMouseEnter={() => setTooltip("Dashboard")} onMouseLeave={() => setTooltip("")}>
            ...
            <li>
              <Link href="/dashboard/local-infos" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "LocalInfos" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => setSelected("LocalInfos")} onMouseEnter={() => setTooltip("Infos Locales")} onMouseLeave={() => setTooltip("")}>
            ...
            <li>
              <Link href="/dashboard/videos" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Videos" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => setSelected("Videos")} onMouseEnter={() => setTooltip("Vidéos")} onMouseLeave={() => setTooltip("")}>
            ...
            <li>
              <Link href="/dashboard/members" className={`flex items-center gap-2 p-2 text-sm rounded ${selected === "Utilisateurs" ? "bg-white font-semibold" : "font-medium hover:bg-orange-50"}`} onClick={() => setSelected("Utilisateurs")} onMouseEnter={() => setTooltip("Utilisateurs")} onMouseLeave={() => setTooltip("")}>
          ...
          <ul className="mt-2 space-y-2">
            <li>
              <Link href="/dashboard/settings" className="flex items-center gap-2 font-medium p-2 text-sm rounded hover:bg-orange-50" onClick={() => setSelected("Paramètres")} onMouseEnter={() => setTooltip("Paramètres")} onMouseLeave={() => setTooltip("")}>
                ...
                <p className={`${isCollapsed ? "hidden" : "hidden md:block"}`}>Paramètres</p>

                {/* Tooltip */}
                <div role="tooltip" className={`absolute -right-1 translate-x-full w-fit z-50 inline-block px-3 py-2 text-sm font-medium text-white text-nowrap bg-gray-800 rounded-lg shadow-sm transition-all ${tooltip === "Paramètres" && isCollapsed ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                  Paramètres
                </div>
              </Link>
            </li>
            <li>
              <Link href="/dashboard/report" className="flex items-center gap-2 font-medium p-2 text-sm rounded hover:bg-orange-50" onClick={() => setSelected("Signaler")} onMouseEnter={() => setTooltip("Signaler")} onMouseLeave={() => setTooltip("")}>
